...
define([
     ...
     * @returns 
     */
    let defaultApiEndpoint = "https://biwrapper.arria.com/"; //Prod
    defaultApiEndpoint = "https://biwrapper-dev.arria.com/"; //pre-Prod
    ...
    let OOTBGenerateEndPoint = "https://ip9f2qnhhe.execute-api.us-east-1.amazonaws.com/v1/ootbgloo/";
    let OOTBEndPoint = "https://xvm14ledh6.execute-api.us-east-1.amazonaws.com/test/";
    let OOTBEndPointKey = "okv0YlGSLV6POx0E69zjfnuvgS10Jhz6y36nyoF6";
    let OOTBEndPointAPIKey = "lNUjsCNPM28a9yWQVeQlM4jSkqEDsEyEaetNjumf";
    OOTBGenerateEndPoint = "https://3kc0dpq1ml.execute-api.us-east-1.amazonaws.com/bugfix-OS-397-certain-s/arriatestootbglooapi";
    OOTBEndPointAPIKey = "ucLf3qvgXK454kXFc5Rmd95SkLFXUbw41CstQ8Vj";
    let entityType = {
        entityTypes: []
    };
    ...
    function createNarrativeUI(chartId, $element, chartObj) {
        ...
        element += '<div class="col-md-12">';
        element += '<div class="col-md-6 title"><img src="' + apiEndpoint + 'arria/images/arrow_white.png" id="arrow-json' + chartId + '"><label>View Dataset in JSON</label></div>';
        ...
        element += '<div class="col-md-12">';
        element += '<div class="col-md-12"><img src="' + apiEndpoint + 'arria/images/arrow_white.png" id="arrow-script' + chartId + '"><label>View CSV Payload</label></div>';
        element += '</div>';
        element += '</div>';
    ...
    return {
        ...
        paint: function ($element, layout) {
            ...
            this.backendApi.getProperties().then(function (reply) {
                var chartId = "_" + reply.qInfo.qId;
                var measuresInfo = reply.qHyperCubeDef.qMeasures;
                for (var z = 0; z < measuresInfo.length; z++) {
                    measuresList.push(measuresInfo[z].qDef.qDef);
                    var measureColumn = measuresInfo[z].qDef.qDef.split('(');
                    var columnData = measureColumn[1].split(')');
                    if (columnData[0].indexOf('[') !== -1) {
                        var arrayColumn = columnData[0].split('[');
                        arrayColumn = arrayColumn[1].split(']');
                        if (columnsArr.indexOf(arrayColumn[0]) === -1) {
                            columnsArr.push(arrayColumn[0]);
                            csv_columnData.push(arrayColumn[0]);
                        }
                    } else {
                        if (columnsArr.indexOf(columnData[0]) === -1) {
                            columnsArr.push(columnData[0]);
                            csv_columnData.push(columnData[0]);
                        }
                    }
                        ...
                        _this.backendApi.getProperties().then(function (res) {
                                        ...
                                        if (!presistOOTBLoad) {
                                            ...
                                            if (dataAttr === columns[index].name) {
                                                if (index !== parseInt(dataid)) {
                                                    ...
                                                    neutralContainer.setAttribute('id', 'neutral' + index + chartId);
                            ...
                            advance_studio_toggle.onchange = function () {
                                if (advance_studio_toggle.checked) {
                                    ...
                                    if (describeTbl) {
                                        ...
                                        document.querySelector('#advancedata-json' + chartId + ' .col-md-6').innerHTML = '<img src="' + apiEndpoint + 'arria/images/arrow_white.png"><label>View Dataset in JSON</label>';
                            ...
                            tabNarrativeElement.onclick = function () {
                                ...
                                if (checkSliderBtn.checked) {
                                    ...
                                    if (describeTbl) {
                                        ...
                                        advanceCustomScriptElement.parentElement.setAttribute("class", "col-md-6 export");
                                        advanceDatasetJsonElement.parentElement.setAttribute("class", "col-md-6 data-json");
                                        document.querySelector('#data-json' + chartId + ' .col-md-6').innerHTML = '<img src="' + apiEndpoint + 'arria/images/arrow_white.png"><label>View Dataset in JSON</label>';
                                    }
                                    targetView = "simple";
                                }
                                    ...
                                    if (narrativeTabElement.style.display !== "block") {
                                        ...
                                        if (checkSliderBtn.checked) {
                                            ...
                                            if (describeTbl && advance_studio_toggle.checked) {
                                                ...
                                                advanceDatasetJsonElement.parentElement.setAttribute("class", "col-md-6 data-json");
                                                if (advanceExport.style.display === "block")
                                                    document.querySelector('#advancedata-json' + chartId + ' .col-md-6').innerHTML = '<img src="' + apiEndpoint + 'arria/images/arrow_up_black.png"><label>View Dataset in JSON</label>';
                                                else
                                                    document.querySelector('#advancedata-json' + chartId + ' .col-md-6').innerHTML = '<img src="' + apiEndpoint + 'arria/images/arrow_white.png"><label>View Dataset in JSON</label>';
                                                advanceCheckboxContainer.style.display = "none";
                                            }
                                            ...
                                            if (describeTbl) {
                                                ...
                                                if (simpleExport.style.display === "block") {
                                                    document.querySelector('#download-json' + chartId + ' ' + 'img').setAttribute('src', apiEndpoint + 'arria/images/download_white.png');
                                                    document.querySelector('#data-json' + chartId + ' .col-md-6').innerHTML = '<img src="' + apiEndpoint + 'arria/images/arrow_up_black.png"><label>View Dataset in JSON</label>';
                                                } else {
                                                    document.querySelector('#download-json' + chartId + ' ' + 'img').setAttribute('src', apiEndpoint + 'arria/images/download_white.png');
                                                    document.querySelector('#data-json' + chartId + ' .col-md-6').innerHTML = '<img src="' + apiEndpoint + 'arria/images/arrow_white.png"><label>View Dataset in JSON</label>';
                                                }
                            ...
                            function callUpdate(url) {
                                ...
                                try {
                                    ...
                                    if (url.indexOf("studio.arria.com") !== -1)
                                        reqParams = "arriaURL=" + url + "&headername=Authorization&authKey=bearer " + authKey.value.trim() + "&appData=" + encodeURIComponent(finalData) + "&biSource=powerbi";
                                    else if (authKey.value !== "")
                                        reqParams = "arriaURL=" + url + "&headername=Authorization&authKey=bearer " + authKey.value.trim() + "&appData=" + encodeURIComponent(finalData) + "&biSource=powerbi";
                                    else
                                        reqParams = "arriaURL=" + url + "&appData=" + encodeURIComponent(finalData) + "&biSource=powerbi";
                                    if (window.navigator.onLine)
